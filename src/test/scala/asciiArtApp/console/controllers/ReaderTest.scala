...
//
//import asciiArtApp.console.views.{Argument, ArgumentWithStringParameters, ArgumentWithoutParameter, Reader}
...
//      "image",
//      1,
//      { (arguments: List[String]) => new ArgumentWithStringParameters("input", "image", arguments.head) }
//    )
